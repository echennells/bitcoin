...
def main():
    ...
    print()
    print("  Bitcoin does TWO simple checks:")
    print()
    print("  CHECK #1: Does your public key match the address?")
    print("  ┌─────────────────────────────────────────────┐")
    print("  │ Your Public Key → [HASH] → Address         │")
    print("  │                                             │")
    print("  │ If these match... ✓ Keep going!            │")
    print("  └─────────────────────────────────────────────┘")
    print()
    print("  CHECK #2: Is your signature valid?")
    print("  ┌─────────────────────────────────────────────┐")
    print("  │ Your Signature + Your Public Key           │")
    print("  │                                             │")
    print("  │ Math proves you have the secret key        │")
    print("  │ WITHOUT you revealing it!                  │")
    print("  │                                             │")
    print("  │ If signature is valid... ✓ Approved!       │")
    print("  └─────────────────────────────────────────────┘")
    print()
